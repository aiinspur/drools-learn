...
package org.drools.shihu.learn.rules.attribute;
...
//    	KieServices.Factory.get()
	...
	public static void execute(KieServices ks, KieContainer kc) {
		...
		KieSession ksession = kc.newKieSession("attrKS");
		...
		// To set up a ThreadedFileLogger, so that the audit view reflects events whilst
		// debugging,
...
//		message.setMessage("Hello Aiinspur");
//		message.setStatus(Message.HELLO);
		ksession.insert(message);
		
		System.out.println("getFactCount:"+ksession.getFactCount());
...
//		 logger.close();
	...
	public static class Message {
		...
		public String toString() {
			return "Message [message=" + message + ", message1=" + message1 + ", status=" + status + "]";
		}
	}
